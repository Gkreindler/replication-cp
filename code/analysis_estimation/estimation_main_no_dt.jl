...
## Model 3:
	gmm_options["results_suffix"] = "_nodt"  # leave empty by default
	...
	ESTIMATION_PARAMS = model_nodt_dynamic_params(
		theta_fixed_dict=theta_fixed_dict,
		gmm_options=gmm_options)
	momfn = model_nodt_dynamic
