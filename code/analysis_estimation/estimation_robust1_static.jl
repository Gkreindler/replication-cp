...
## 1. Model 2: full model with delta = 90
	gmm_options["results_suffix"] = "_dt_static"  # leave empty by default
	...
	ESTIMATION_PARAMS = model_dt_static_params(theta_fixed_dict=theta_fixed_dict, gmm_options=gmm_options)
