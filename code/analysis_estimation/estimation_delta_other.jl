...
## 2. Model 2: full model with OTHER deltas

	deltas     = [ 0.0, 50.0, 80.0, 95.0, 99.0]
	delta_strs = ["00", "50", "80", "95", "99"]

	for idelta=1:4

		gmm_options["results_suffix"] = "_delta_" * delta_strs[idelta]  # leave empty by default
