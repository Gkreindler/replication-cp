...
## Paths
    ...
    rootpath_params      =  rootpath * "model/estimation_results/results_propwage/"
    rootpath_params_boot = [rootpath * "model/estimation_results/results_boot_propwage/"]

    ### Simulation output path
	rootpath_output = rootpath * "model/simulation_results/propwage_boot/"
